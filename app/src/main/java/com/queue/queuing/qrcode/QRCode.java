...
public class QRCode {
     ...
     * @param data データ
     * @param mode モード
     * @see com.queue.queuing.qrcode.Mode
     */
	public void addData(String data, int mode) {

		switch(mode) {

		case com.queue.queuing.qrcode.Mode.MODE_NUMBER :
			addData(new QRNumber(data) );
			break;

		case com.queue.queuing.qrcode.Mode.MODE_ALPHA_NUM :
			addData(new QRAlphaNum(data) );
			break;

		case com.queue.queuing.qrcode.Mode.MODE_8BIT_BYTE :
